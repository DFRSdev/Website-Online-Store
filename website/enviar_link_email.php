...
//Envio de mensagem para o email do contacto a confirmar a receção dos dados:
    ...
    $mensagem_1->__set('assunto' , utf8_decode("Confirmação de Registo - Miguel & Alex!"));
    $mensagem_1->__set('mensagem' , utf8_decode("<table style='border-collapse: separate; width: 100%; background: rgb(255, 255, 255); border-radius: 8px;'>
              <tbody><tr>
                    ...
                    <tbody><tr>
                      <td style='font-size: 14px; vertical-align: top;'>
                        ...
                        <h1 style='font-size: 20px; font-weight: 600; margin: 0px 0px 15px; color: rgb(21, 21, 21);'>
                            Email de verificação da Conta:
                        </h1>
                        <p style='font-size: 16px; font-weight: normal; margin: 0px 0px 15px; color: rgb(21, 21, 21);'>  </p><p style='color: rgb(21, 21, 21);'>Para ativar a sua conta necessitamos de verificar o seu email, por favor carregue no botão abaixo.</p>
...
<p style='color: rgb(21, 21, 21);'></p>
   ...
   try {
		...
		$headers_1 .= "From: Miguel & Alex Loja Online/r/n"; //Devem personalizar com o nome do vosso projeto
