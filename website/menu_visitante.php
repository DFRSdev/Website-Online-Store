                        ...
                        <ul class="top-menu">
                            <li>
                                ...
                                <ul style="height:50px;">
                                    ...
                                    <li><a href="#signin-modal" data-toggle="modal">Iniciar Sessão / Registar</a></li>
                                </ul>
                            </li>
                        </ul><!-- End .top-menu -->
                ...
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="index.php" class="logo">
                            <img src="assets/images/logo.webp" alt="Molla Logo" width="130" height="50">
                        </a>
                    </div><!-- End .header-left -->
...
<?php 
    ...
    $selecionamento1 = "SELECT * FROM favoritos WHERE (id = '" . $_SESSION["id"] . "' OR session_id = '" . session_id() . "')";
    $result_favoritos = mysqli_query($ligax, $selecionamento1);
    $quantidade_favoritos = mysqli_num_rows($result_favoritos);
} else {
     $selecionamento1 = "SELECT * FROM favoritos WHERE session_id = '".session_id()."'";
    $result_favoritos = mysqli_query($ligax, $selecionamento1);
       $quantidade_favoritos = mysqli_num_rows($result_favoritos);
}
                     ...
                     ?>
                      <div class="wishlist">
                            <a href="index.php?page=favoritos" title="Wishlist">
                                <div class="icon">
                                    <i class="icon-heart-o"></i>
                                    <span class="wishlist-count badge"><?php echo $quantidade_favoritos;?></span>
                                </div>
                                <p>Favoritos</p>
                            </a>
       ...
       $qua = mysqli_num_rows($result);
                     ...
                     ?>
                        ...
                        <div class="dropdown cart-dropdown">
                            <a href="index.php?page=carrinho" class="dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                                <div class="icon">
                                    ...
                                    <div class="product">
                                        <div class="product-cart-details">
                                            <h4 class="product-title">
                                                <a href="index.php?page=detalhes_produto&cod_produto=<?php echo $cc_cod_produto?>"><?php echo $nome?></a>
                                            </h4>
                                        ...
                                        <figure class="product-image-container">
                                            <a href="index.php?page=detalhes_produto&cod_produto=<?php echo $cc_cod_produto?>" class="product-image">
 ...
 <?php } ?>
                                ...
                                <div class="dropdown-cart-action">
                                    ...
                                    <a href="index.php?page=checkout_entrega" class="btn btn-outline-primary-2"><span>Comprar</span><i class="icon-long-arrow-right"></i></a>
                                </div><!-- End .dropdown-cart-total -->
      ...
      <?php
        ...
        <div class="mobile-menu-wrapper">
            ...
            <form action="" method="GET" class="mobile-search">
                ...
                <input type="search" class="form-control" name="pesquisa_produtos" id="pesquisa"  value="<?php if(isset($_GET['pesquisa_produtos'])){echo $_GET['pesquisa_produtos'];} ?>"  placeholder="Escreve aqui o que procuras..." required="">
                <button class="btn btn-primary" type="submit"><i class="icon-search"></i></button>
            </form>
