...
if(isset($_POST['criar_marca'])){

                      $nome_marca=$_POST['nome_marca'];
                      $descricao=$_POST['descricao'];
                      $estado=$_POST['estado'];

                       $insert="insert into marcas (nome_marca,descricao,estado) VALUES ('".$nome_marca."','".$descricao."','".$estado."')";
                       //echo $insert;
...
$query="update marcas set foto_nome='".$file_name."',foto_tipo='".$file_type."',
                               foto_tamanho='".$file_size."',foto_dados='".$data."'  where cod_marca='".$file_id."' ";
                               //echo $query;
            ...
            toastr["success"]("Marca criada com sucesso") 
                          </script>
                          <?php
                       }else{ 
                        ?>
...
<h3 class="box-title">Criar Marcas</h3>
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                               ...
                               <div style="float:left;width: calc(100% - 130px )">
                                    ...
                                    <input formfield="titulo" langmanager="true" formtype="input" style="font-size:16px" class="text-input2 required form-control" type="text" id="nome" name="nome_marca" value="" aria-required="true" required>
...
<div style="padding:20px;border-bottom:1px solid #f3f3f3;overflow: hidden;">
                           <div class="" style="border-bottom: 0px solid #f3f3f3;margin-bottom: 0px;overflow: hidden;position: relative;top:1px">
                              <input type="submit" name="criar_marca" class="btn btn-primary"  value="Guardar Marca">
</div>
                          </div>
             </form>
                </table>
