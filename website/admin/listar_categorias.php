        ...
        <div id="example1_filter" class="dataTables_filter">
          <form action="" method="GET">
            <label style="position: relative;right: 570px;">Search: 
              <input type="hidden" name="page" value="listar_categorias">
              ...
              <div class="box">
                ...
                <div class="box-body">
                     <?php
                            ...
                            if(isset($_GET['pesquisa'])){
                                      $consulta="select * from categorias where nome_categoria like '%".$_GET['pesquisa']."%' order by nome_categoria ASC";
                                    } 

                                    else {
                                      $consulta= "select * from categorias order by cod_categoria ASC";
                                    }
...
?>
                      ...
                      <td>
                       ...
                       <img class="circle-rounded me-3" src="showfile_fotocategoria.php?cod_categoria=<?php echo $cod_categoria;?>" alt="" width="30" height="30">
                          <?php echo $nome ?>
                  ...
                  <a href="index.php?page=editar_categorias&cod_categoria=<?php echo $cod_categoria;?>"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                    </tr>
                  <?php
            ...
            if(($pag_ant) && ($pag>1)){
                  echo "
                        <li class='paginate_button previous' id='example1_previous'>
                                      ...
                                      <a href='index.php?page=listar_categorias&pag=$pag_ant&pesquisa=$pesquisa'>Anterior
    ...
    for ($i=1;$i<=$num_pag;$i++) {
            ...
            if($i!=$pag) {
                echo "<li class='paginate_button'>
                                      <a href='index.php?page=listar_categorias&pag=$i&pesquisa=$pesquisa' class='paginate_button'>
                    $i
                    </a></li>";
            } 
            else {
                 echo "<li class='paginate_button active'>
                                      <a href='index.php?page=listar_categorias&pag=$i&pesquisa=$pesquisa' class='paginate_button active'>
                  $i
                    </a></li>";
            }
        }
    ...
    if ($pag+1<=$num_pag) {
            echo "   <li class='paginate_button next' id='example1_next'> 
                                      <a href='index.php?page=listar_categorias&pag=$pag_seg&pesquisa=$pesquisa' class='flex-c-m how-pagination1 trans-04 m-all-7'>
        Seguinte</a></li>";
    }
    ?> 
                      </ul>
