...
?>      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Listar Utilizadores</li>
          </ol>
        </section>
        ...
        <div id="example1_filter" class="dataTables_filter">
          <form action="" method="GET">
            <label style="position: relative;right: 570px;">Search: 
              <input type="hidden" name="page" value="listar_utilizadores">
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Listar Utilizadores</h3>
                </div>
                <div class="box-body">
                     <?php

                            if(isset($_GET['pesquisa'])){
                                      $consulta="select * from users where name like '%".$_GET['pesquisa']."%' order by name ASC";
                                    } 
  ...
  $estado=$registo['estado'];
                      ...
                      <tr>
                        <td>
                          ...
                          <img class="circle-rounded me-3" src="showfile_fotoperfil.php?id=<?php echo $id;?>" alt="" width="30" height="30">
                          <?php echo $nome ?>
                        ...
                        <td><?php echo $email ?> </td>
                                                ...
                                                if($perfil==3){
                                            ?>
                                             <td class=""><?php echo "Fundador";?></td>
                                    <?php
                                                }
                                            else{?>
                      <?php if($perfil==0){ ?>
                        <td class="">Não Autenticado</td>
                      <?php } ?>
                      <?php if($perfil==1){ ?>
                        <td class="">Cliente</td>
                      <?php } ?>
                      ...
                      $estado=0;}
                                            ...
                                            if($estado==0) { ?><td class="">Inativo</td><?php }
                                            else if($estado==1) { ?><td class="">Ativo</td><?php }

                                            ?>  
                     
                     
                                                    <?php
                                                     $subscricao="select subscricao from newsletter where email='".$email."'";
   $result_news=mysqli_query($ligax,$subscricao);
   $n=mysqli_num_rows($result_news);
   if($n>0){
   $registo_news=mysqli_fetch_assoc($result_news);
  $subscricao=$registo_news['subscricao'];
                                                    if($subscricao==1){ ?>
                        <td class="">Ativo</td>
                      <?php } 
                       else{ ?>
                  ...
                  <a href="verutilizador.php?id=<?php echo $id;?>"><i class="fa fa-address-book"  aria-hidden="true"></i></a></td>
            ...
            if(($pag_ant) && ($pag>1)){
                  echo "
                        <li class='paginate_button previous' id='example1_previous'>
                                      ...
                                      <a href='index.php?page=listar_utilizadores&pag=$pag_ant&pesquisa=$pesquisa'>Anterior
    ...
    for ($i=1;$i<=$num_pag;$i++) {
            ...
            if($i!=$pag) {
                echo "<li class='paginate_button'>
                                      <a href='index.php?page=listar_utilizadores&pag=$i&pesquisa=$pesquisa' class='paginate_button'>
                    $i
                    </a></li>";
            } 
            else {
                 echo "<li class='paginate_button active'>
                                      <a href='index.php?page=listar_utilizadores&pag=$i&pesquisa=$pesquisa' class='paginate_button active'>
                  $i
                    </a></li>";
            }
        }
    ...
    if ($pag+1<=$num_pag) {
            echo "   <li class='paginate_button next' id='example1_next'> 
                                      <a href='index.php?page=listar_utilizadores&pag=$pag_seg&pesquisa=$pesquisa' class='flex-c-m how-pagination1 trans-04 m-all-7'>
        Seguinte</a></li>";
    }
    ?> 
                      </ul>
